    ...
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-item" v-for="menu in sidebarMenu">
                    <router-link v-bind:to="menu.link" class="nav-link"><i v-bind:class="'nav-icon ' + menu.icon"></i>{{ menu.name }}</router-link>
                    <!-- <a class="nav-link" v-bind:href="menu.link"><i v-bind:class="'nav-icon ' + menu.icon"></i> {{ menu.name }}</a> -->
                </li>
                <!-- <li class="nav-item">
